package com.grapeapi.project.controller;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.google.gson.Gson;
import com.grapeapi.apicommon.model.entity.UserInterfaceInfo;
import com.grapeapi.project.annotation.AuthCheck;
import com.grapeapi.project.common.*;
import com.grapeapi.project.constant.CommonConstant;
import com.grapeapi.project.exception.BusinessException;
import com.grapeapi.project.model.dto.interfaceinfo.InterfaceInfoAddRequest;
import com.grapeapi.project.model.dto.interfaceinfo.InterfaceInfoInvokeRequest;
import com.grapeapi.project.model.dto.interfaceinfo.InterfaceInfoQueryRequest;
import com.grapeapi.project.model.dto.interfaceinfo.InterfaceInfoUpdateRequest;
import com.grapeapi.project.model.enums.InterfaceInfoStatusEnum;
import com.grapeapi.project.service.InterfaceInfoService;
import com.grapeapi.project.service.UserInterfaceInfoService;
import com.grapeapi.project.service.UserService;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        Object res = invokeInterfaceInfo(oldInterfaceInfo.getName(), oldInterfaceInfo.getRequestParams(), accessKey, secretKey);
        if (res == null) {
            throw new BusinessException(ErrorCode.NOT_FOUND_ERROR);
        }
...
//        com.grapeapi.apiclientsdk.model.User user = new com.grapeapi.apiclientsdk.model.User();
...
//        }
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        Object res = invokeInterfaceInfo(oldInterfaceInfo.getName(), requestParams, accessKey, secretKey);
        if (res == null) {
            throw new BusinessException(ErrorCode.NOT_FOUND_ERROR);
        }
        if (res.toString().contains("Error request")) {
...
//        Gson gson = new Gson();
//        com.grapeapi.apiclientsdk.model.User user = gson.fromJson(userRequestParams, com.grapeapi.apiclientsdk.model.User.class);
...
//        return ResultUtils.success(usernameByPost);
    ...
    private Object invokeInterfaceInfo(String methodName, String userRequestParams,
        ...
        try {
            Class<?> clientClazz = Class.forName("com.grapeapi.apiclientsdk.client.OpenApiClient");
            // 1. 获取构造器，参数为ak,sk
